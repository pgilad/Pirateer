...
angular.module('app').service('searchService', [
    '$http', '$q', 'ptStorageService', 'ptSearchHelpers',
    function($http, $q, ptStorageService, ptSearchHelpers) {
    ...
    '$http', 'ptStorageService', '$rootScope',
    function($http, ptStorageService, $rootScope) {
        ...
        return {
            ...
            getRatingOfMovie: function(params) {
                ...
                angular.extend(selectedMovie[originalSearchString], {
                    indexArr: indexArr
                });
    ...
    .service('ptStorageService', function() {
        ...
        var setCacheOptionsByValue = function(value) {
            ...
            DEBUG && console.log('set user option in analytics');
